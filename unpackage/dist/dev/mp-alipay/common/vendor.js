...
{var mocks = _ref6.mocks,initRefs = _ref6.initRefs;
  ...
  initAppLocale(_vue.default, vm, my.getSystemInfoSync().language || 'zh-Hans');
...
function parseApp(vm) {
  ...
  _vue.default.prototype.$onAliGetAuthorize = function onAliGetAuthorize(method, $event) {var _this5 = this;
    my.getPhoneNumber({
...
function parseComponent(vueComponentOptions) {var _initVueComponent3 =
  ...
  var componentOptions = {
    ...
    data: initData(vueOptions, _vue.default.prototype),
    props: props,
    didMount: function didMount() {var _this6 = this;
      if (my.dd) {// 钉钉小程序底层基础库有 bug,组件嵌套使用时,在 didMount 中无法及时调用 props 中的方法
        setTimeout(function () {
          initVm.call(_this6, VueComponent);
        }, 4);
      } else {
